...
class EntityResultTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new Result('https://example.edu/terms/201601/courses/7/sections/1/assess/1/users/554433/attempts/1/results/1'))
            ...
            ->setScoredBy((new SoftwareApplication('https://example.edu/autograder'))
                ->setDateCreated(new \DateTime('2016-11-15T10:55:58.000Z')))
