...
class EventThreadMarkedAsReadTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new ThreadEvent())
            ->setActor(new Person('https://example.edu/users/554433'))
            ->setAction(new Action(Action::MARKED_AS_READ))
            ->setObject((new Thread('https://example.edu/terms/201601/courses/7/sections/1/forums/1/topics/1'))
                ...
                ->setDateCreated(new \DateTime('2016-11-15T10:16:00.000Z')))
