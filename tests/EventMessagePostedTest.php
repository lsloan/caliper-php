...
class EventMessagePostedTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new MessageEvent())
            ...
            ->setObject((new Message('https://example.edu/terms/201601/courses/7/sections/1/forums/2/topics/1/messages/2'))
                ->setCreators([
                    (new Person('https://example.edu/users/554433')),
                ])
                ->setBody('Are the Caliper Sensor reference implementations production-ready?')
                ->setIsPartOf((new Thread('https://example.edu/terms/201601/courses/7/sections/1/forums/2/topics/1'))
                    ->setName('Caliper Adoption')
