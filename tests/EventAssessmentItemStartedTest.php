...
class EventAssessmentItemStartedTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new AssessmentItemEvent())
            ...
            ->setObject((new AssessmentItem('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/3'))
            ...
            ->setGenerated((new Attempt('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/3/users/554433/attempts/1'))
            ...
            ->setId('urn:uuid:1b557176-ba67-4624-b060-6bee670a3d8e')
        );
    }
}
