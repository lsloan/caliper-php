    ...
    function setUp() {
        ...
        $this->setTestObject(
            (new NavigationEvent())
                ...
                ->setReferrer(
                    (new WebPage('https://example.edu/terms/201601/courses/7/sections/1/pages/4'))
                )
                ->setEdApp(
                    (new SoftwareApplication('https://example.com'))
                )
                ->setGroup(
                ...
                ->setSession(
                    (new Session('https://example.com/sessions/b533eb02823f31024e6b7f53436c42fb99b31241'))
                        ->setStartedAtTime(
                            new \DateTime('2016-11-15T10:00:00.000Z'))
                )
                ->setUuid(
                    '4be6d29d-5728-44cd-8a8f-3d3f07e46b61'
                )
                ->setFederatedSession(
