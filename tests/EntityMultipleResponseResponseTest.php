...
class EntityMultipleResponseResponseTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new MultipleResponseResponse('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/3/users/554433/responses/1'))
            ->setAttempt((new Attempt('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/3/users/554433/attempts/1'))
                ...
                ->setCount(1)
                ->setStartedAtTime(new \DateTime('2016-11-15T10:15:22.000Z'))
                ->setEndedAtTime(new \DateTime('2016-11-15T10:15:30.000Z')))
            ->setDateCreated(new \DateTime('2016-11-15T10:15:22.000Z'))
            ->setStartedAtTime(new \DateTime('2016-11-15T10:15:22.000Z'))
            ->setEndedAtTime(new \DateTime('2016-11-15T10:15:30.000Z'))
            ->setValues([
                'A',
