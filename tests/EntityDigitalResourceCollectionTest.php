...
class FubarContext extends \IMSGlobal\Caliper\context\Context {
    const
        FUBAR = 'http://example.org/fubar';
}
...
class EntityDigitalResourceCollectionTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new DigitalResourceCollection('https://example.edu/terms/201601/courses/7/sections/1/resources/2'))
