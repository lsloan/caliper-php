...
class EntityFillinBlankResponseTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new FillinBlankResponse('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/1/users/554433/responses/1'))
            ->setAttempt((new Attempt('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/1/users/554433/attempts/1'))
                ->setAssignee(new Person('https://example.edu/users/554433'))
                ->setAssignable((new AssessmentItem('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/1'))
