...
class EventAssessmentItemSkippedTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new AssessmentItemEvent())
            ...
            ->setAction(new Action(Action::SKIPPED))
            ->setObject((new AssessmentItem('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/2'))
                ->setName('Assessment Item 2')
            ...
            ->setEventTime(new \DateTime('2016-11-15T10:14:30.000Z'))
