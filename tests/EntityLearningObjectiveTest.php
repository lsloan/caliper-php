...
class EntityLearningObjectiveTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new AssignableDigitalResource('https://example.edu/terms/201601/courses/7/sections/1/assign/2'))
            ->setName('Caliper Profile Design')
            ->setDescription('Choose a learning activity and describe the actions, entities and events that comprise it.')
            ->setLearningObjectives([
                (new LearningObjective('https://example.edu/terms/201601/courses/7/sections/1/objectives/1'))
                    ->setName('Research techniques')
                    ->setDescription('Demonstrate ability to model a learning activity as a Caliper profile.')
            ...
            ->setDateToStartOn(new \DateTime('2016-11-15T11:59:59.000Z'))
