    ...
    function setUp() {
        ...
        $this->setTestObject((new SessionEvent())
            ...
            ->setObject((new Session('https://example.edu/sessions/7d6b88adf746f0692e2e873308b78c60fb13a864'))
                ->setUser(new Person('https://example.edu/users/112233'))
                ->setDateCreated(new \DateTime('2016-11-15T10:15:00.000Z'))
                ->setStartedAtTime(new \DateTime('2016-11-15T10:15:00.000Z'))
                ->setEndedAtTime(new \DateTime('2016-11-15T11:15:00.000Z'))
                ->setDuration('PT3600S')
            )
            ->setEventTime(new \DateTime('2016-11-15T11:15:00.000Z'))
