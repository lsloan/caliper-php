...
class EventOutcomeGradedTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new OutcomeEvent())
            ...
            ->setObject((new Attempt('https://example.edu/terms/201601/courses/7/sections/1/assess/1/users/554433/attempts/1'))
                ->setAssignable(new Assessment('https://example.edu/terms/201601/courses/7/sections/1/assess/1'))
                ...
                ->setEndedAtTime(new \DateTime('2016-11-15T10:55:12.000Z'))
                ->setDuration('PT50M12S')
            )
            ->setEventTime(new \DateTime('2016-11-15T10:57:06.000Z'))
            ->setGenerated((new Result('https://example.edu/terms/201601/courses/7/sections/1/assess/1/users/554433/results/1'))
                ->setAttempt(new Attempt('https://example.edu/terms/201601/courses/7/sections/1/assess/1/users/554433/attempts/1'))
                ->setNormalScore(15.0)
                ->setTotalScore(15.0)
            ...
            ->setId('urn:uuid:a50ca17f-5971-47bb-8fca-4e6e6879001d')
        );
    }
}
