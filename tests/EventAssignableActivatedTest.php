...
class EventAssignableActivatedTest extends CaliperTestCase {
    function setUp() {
        ...
        $this->setTestObject((new AssignableEvent())
            ->setActor(new Person('https://example.edu/users/112233'))
            ...
            ->setObject((new Assessment('https://example.edu/terms/201601/courses/7/sections/1/assess/1'))
                ...
                ->setDatePublished(new \DateTime('2016-11-12T10:10:00.000Z'))
                ->setDateToActivate(new \DateTime('2016-11-12T10:15:00.000Z'))
            ...
            ->setEventTime(new \DateTime('2016-11-12T10:15:00.000Z'))
            ...
            ->setMembership((new Membership('https://example.edu/terms/201601/courses/7/sections/1/rosters/1'))
                ->setMember(new Person('https://example.edu/users/112233'))
                ->setOrganization(new CourseSection('https://example.edu/terms/201601/courses/7/sections/1'))
                ->setRoles([new Role(Role::INSTRUCTOR)])
                ->setStatus(new Status(Status::ACTIVE))
                ->setDateCreated(new \DateTime('2016-08-01T06:00:00.000Z')))
            ->setSession((new Session('https://example.edu/sessions/f095bbd391ea4a5dd639724a40b606e98a631823'))
                ->setStartedAtTime(new \DateTime('2016-11-12T10:00:00.000Z')))
            ->setId('urn:uuid:2635b9dd-0061-4059-ac61-2718ab366f75')
        );
    }
}
